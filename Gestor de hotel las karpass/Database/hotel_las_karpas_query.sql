...
-- Creaci�n de tablas (sin llaves foraneas)
...
INSERT INTO hotel.dbo.Empleados
	...
	VALUES
	('Administrador', 'Num', '1', '2000-01-01', 1, 50688888888, 'admin@gmail.com', 1234, 'masculino', 'Lim�n, Lim�n, Lim�n')
...
VALUES 
  ('Juan', 'Martinez', 'Gomez', 'Espa�a', 'Calle Mayor 123', '1990-05-15', 34678901234, 'juan.martinez@example.com'),
  ('Maria', 'Garcia', 'Lopez', 'M�xico', 'Avenida Reforma 456', '1985-10-20', 5255555555, 'maria.garcia@example.com'),
